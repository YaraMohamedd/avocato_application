...
class ConsultFinishedPage extends StatefulWidget {

  @override
  _ConsultFinishedPageState createState() => _ConsultFinishedPageState();
}

class _ConsultFinishedPageState extends State<ConsultFinishedPage> {
  @override
