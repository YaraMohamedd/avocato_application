...
class ConsultActivePage extends StatefulWidget {

  @override
  _ConsultActivePageState createState() => _ConsultActivePageState();
}

class _ConsultActivePageState extends State<ConsultActivePage> {
  @override
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: Center(child: Text('نشطه',style: TextStyle(fontSize:15,fontFamily: 'Almarai',color: mainColor)))),
