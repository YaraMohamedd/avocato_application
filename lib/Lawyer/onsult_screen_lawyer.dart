...
class ConsultScreenLawyer extends StatefulWidget {

  @override
  _ConsultScreenLawyerState createState() => _ConsultScreenLawyerState();
}

class _ConsultScreenLawyerState extends State<ConsultScreenLawyer> {
  @override
                ...
                Row(
                  ...
                  children: [
                    Container(
                        ...
                        child: Center(child: Text('ملغيه',style: TextStyle(fontSize:15,fontFamily: 'Almarai',color: whiteColor)))),
