...
class ConsultActivePageLawter extends StatefulWidget {

  @override
  _ConsultActivePageLawterState createState() => _ConsultActivePageLawterState();
}

class _ConsultActivePageLawterState extends State<ConsultActivePageLawter> {
  @override
