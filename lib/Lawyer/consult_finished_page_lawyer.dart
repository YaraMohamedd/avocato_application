...
class ConsultFinishedPageLawyer extends StatefulWidget {

  @override
  _ConsultFinishedPageLawyerState createState() => _ConsultFinishedPageLawyerState();
}

class _ConsultFinishedPageLawyerState extends State<ConsultFinishedPageLawyer> {
  @override
      ...
      body: SingleChildScrollView(
        child: Stack(
          children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                        ...
                        child: Center(child: Text('منتهيه',style: TextStyle(fontSize:15,fontFamily: 'Almarai',color: mainColor)))),
                    Center(child: Text('نشطه',style: TextStyle(fontSize:15,fontFamily: 'Almarai',color: mainColor))),
                    Center(child: Text('انتظار',style: TextStyle(fontSize:15,fontFamily: 'Almarai',color: mainColor))),
                  ...
                  child: Column(
                    children: [
                      Padding(
                        ...
                        child: Text('احمد محمد',style: TextStyle(color: mainColor,fontSize: 15,fontFamily: 'Almarai'),),
                      ),
                      Align(
                          alignment: Alignment.topRight,
                          child: Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text('االموعد المحدد:12/12',style: TextStyle(color: mainColor,fontSize: 15,fontFamily: 'Almarai'),),
                          )),
                      Align(
                          alignment: Alignment.topRight,
                          child: Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: Text('تكلفة الاستشاره:1000جنيه',style: TextStyle(color: mainColor,fontSize: 15,fontFamily: 'Almarai'),),
                          )),
            ...
            Container(
              margin: EdgeInsets.only(top: 139,left: 170),
              child: CircleAvatar(
                radius: 30,
